  ...
  return (
    <div className='flex items-center pt-[8%] pb-[18%] lg:pb-[8%] gap-1 flex-col lg:flex-row h-screen lg:h-auto justify-between '>
      ...
      <div className='lg:w-[55%] '>
        <div className='bg-transparent  lg:py-[18%] lg:py-[10%] px-[10%]' data-aos="fade" data-aos-duration="1500">
          <div className='lg:w-4/5 mx-auto'>
            ...
            <img src={process.env.PUBLIC_URL+'/images/page04_g01.png'} alt="" className='max-w-full w-2/4 lg:w-3/4 ml-auto'/>
          </div>
      ...
      <div className='lg:hidden'>
        <img src={process.env.PUBLIC_URL+'/images/page04_g02_mb.png'} alt="" className='w-full'/>
      </div>
