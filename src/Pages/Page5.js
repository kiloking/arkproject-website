        ...
        <div className=''>
          <div className='px-[10%]  lg:py-18 '>
            <div className=' lg:w-4/5 mx-auto'>
              ...
              <div className='text-3xl lg:text-4xl font-bold text-[#20494C]  pt-5 pb-5 mb-5'>台灣ESG永續建築先行者</div>
              <div className=' text-lg lg:text-xl leading-9 tracking-wider text-black'>冠德建設以ESG永續精神為核心，翻轉土地能量、創造城市新生。升級進化冠德4.0+，呼應大地的呼喚，為三重市心種下一座森林，深耕城市，生根自然，生命新生。</div>
              <img src={process.env.PUBLIC_URL+'/images/page05_g02.png'} alt="" className='max-w-full w-3/4 mx-auto'/>
            </div>
          </div>
        </div>
        <div className='lg:hidden'>
          <img src={process.env.PUBLIC_URL+'/images/page05_g01_mb.png'} alt="" className='w-full'/>
        </div>
      </div>
    </div>
  )
