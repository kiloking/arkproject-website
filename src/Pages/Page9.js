...
function Page9() {
  return (
    <div className='flex items-center pt-[8%] pb-[18%] ms:pb-8% gap-1 flex-col lg:flex-row bg-[#E7ECEF] lg:bg-transparent h-screen lg:h-auto justify-between'>
      ...
      <div className='lg:w-[55%] order-first lg:order-last' data-aos="fade" data-aos-duration="1500">
        <div className='bg-transparent lg:px-[10%] lg:py-[18%] '>
