...
function Page9() {
  return (
    <div className='flex items-center pt-[8%] pb-[18%] ms:pb-8% gap-5 flex-col md:flex-row bg-[#E7ECEF] md:bg-white h-screen md:h-auto justify-between'>
      <div className=' mmd:w-45% gap-5 order-last md:order-first px-10% md:px-0' data-aos="fade-up" data-aos-duration="1500">
        <img src={process.env.PUBLIC_URL+'/images/page9_p01.png'} alt="" className='w-full'/>
      </div>
      <div className='md:w-[55%] order-first md:order-last' data-aos="fade" data-aos-duration="1500">
        <div className='bg-[#E7ECEF] md:px-[10%] md:py-[18%] '>
          <div className='w-3/4 mx-auto'>
            {/* <img src={process.env.PUBLIC_URL+'/images/page9_title.png'} alt="" className='max-w-full'/> */}
            <div className='text-4xl font-bold text-[#20494C] border-l-[12px] border-[#B9D1DC] md:border-white pt-5 pb-5 pl-[7%] mb-5'>文化，最好的永續建設</div>
