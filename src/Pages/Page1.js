...
function Page1() {
  return (
    <div className='flex justify-between items-center pt-[8%] pb-[18%] lg:pb-[8%] gap-1 flex-col lg:flex-row  h-screen lg:h-auto bg-center bg-cover bg-no-repeat bg-new-b'
