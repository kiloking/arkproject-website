...
function Page6() {
  return (
    <div className='flex items-center pt-[8%] pb-[18%] lg:pb-[8%] gap-1 flex-col lg:flex-row bg-white lg:bg-transparent h-screen lg:h-auto justify-between mx-5'>
      ...
      <div className='lg:w-[50%] '>
        <div className=' lg:py-[18%] lg:py-[10%]  ' data-aos="fade" data-aos-duration="1500">
          <div className='w-4/5 mx-auto'>
            ...
            <div className=' text-lg lg:text-xl leading-9 tracking-wider text-[#1A1A1A]'>「根基營造」承攬政府公路工程、企業總部、民間廠房、醫療大樓及住宅社區，經典業績如：台灣最美也最嚴峻的公路「台９線」工程、中央研究院、新竹光子園區、海基會等。</div>
