...
function Page3() {
  return (
    <div className='flex justify-center items-center pt-[8%] pb-[18%] lg:pb-[8%] gap-1 flex-col lg:flex-row bg-transparent  h-screen lg:h-auto relative '>
      ...
      <div className='lg:w-[55%] order-first lg:order-last'>
        <div className='lg:bg-transparent lg:px-[10%] lg:py-[18%] lg:py-[10%] px-[10%] ' data-aos="fade" data-aos-duration="1500">
